...
const images = computed(() =>
  galleryImages.value.map((img) => ({
    ...
    aspect: img.category === "wide" ? "wide" : "tall",
  })),
);
...
<template>
  <div>
    ...
    <!-- Page Hero -->
    <section
      class="relative h-[50vh] min-h-[360px] flex items-center justify-center overflow-hidden"
    >
      <!-- Background image -->
      <img
        :src="cabinHammock"
      ...
      <div class="relative z-10 text-center px-6">
        <h1
          class="gallery-hero-title font-display text-white text-5xl md:text-6xl mb-4 drop-shadow-lg"
        >
          Notre Univers
        </h1>
        <p
          class="gallery-hero-subtitle text-white/80 text-lg md:text-xl font-heading max-w-xl mx-auto"
        >
    ...
    <section class="bg-sand py-16 md:py-24 px-4 md:px-8">
      <div
        ref="galleryGrid"
        class="max-w-7xl mx-auto columns-2 lg:columns-3 gap-3"
      >
        <div
    ...
    <Teleport to="body">
      <Transition name="lightbox">
        ...
        >
          ...
          <!-- Counter -->
          <div
            class="absolute bottom-5 left-1/2 -translate-x-1/2 text-white/50 text-sm font-heading tracking-wider"
          >
