  ...
  await brevo.transactionalEmails.sendTransacEmail({
    ...
    htmlContent: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
        ...
        <p style="color: #555;">Vous avez demandé la réinitialisation de votre mot de passe pour l'espace admin Ilot Coco Beach.</p>
        ...
        <a href="${resetUrl}" style="display: inline-block; margin: 24px 0; padding: 12px 28px; background-color: #0ea5e9; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">
